...
#Region "Methods"
    Private Sub LoadForm()
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_ReasonCode) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_ReasonCode, frm_ReasonCode)
    ...
    Private Function Validation(aform As SAPbouiCOM.Form) As Boolean
        ...
        If aform.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
            If oApplication.Utilities.getEdittextvalue(aform, "4") = "" Then
                ...
                Return False
            End If
            oRec.DoQuery("Select * from ""@Z_RECO"" where ""U_Z_Code""='" & strWeekEndCode & "'")
        ...
        If oApplication.Utilities.getEdittextvalue(aform, "6") = "" Then
            oApplication.Utilities.Message("Reason Description is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Return False
        End If
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_ReasonCode Then
