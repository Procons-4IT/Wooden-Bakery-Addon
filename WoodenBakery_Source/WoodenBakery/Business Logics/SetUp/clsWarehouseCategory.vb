Public Class clsWarehouseCategory
    Inherits clsBase
...
#Region "Methods"
    Private Sub LoadForm()
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_Warehouse) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_WhsCagetory, frm_Warehouse)
    ...
    Private Function Validation(aform As SAPbouiCOM.Form) As Boolean
        ...
        If aform.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
            If oApplication.Utilities.getEdittextvalue(aform, "4") = "" Then
                oApplication.Utilities.Message("Category Code is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
            End If
            oRec.DoQuery("Select * from ""@Z_OWHC"" where ""U_Z_Code""='" & strWeekEndCode & "'")
            If oRec.RecordCount > 0 Then
                oApplication.Utilities.Message("Reason Code already exists", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
            End If
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_WhsCagetory Then
            ...
            Select Case pVal.MenuUID
                ...
                Case mnu_Cancel
                    If pVal.BeforeAction = True Then
                        ...
                        otest.DoQuery("Select * from ""@Z_LUSR4"" where ""U_Z_Code""='" & strCode & "'")
                        If otest.RecordCount > 0 Then
                            oApplication.Utilities.Message("Warehouse Category already mapped in user mapping...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                            BubbleEvent = False
                            Exit Sub
                        End If
