...
#End Region
  ...
  ByRef dblQuantity As Double, ByVal intRow As Integer, ByVal strStatus As String, ByVal strUOM As String)
        Try
            ...
            strQuery = " Select T1.""U_Z_OffCode"",T1.""U_Z_OQty"",T1.""U_Z_OUOMGroup"",T1.""U_Z_Dis"",T0.""U_Z_PrCode"",T1.""U_Z_DisType"" "
            strQuery += " From "
            strQuery += " ""@Z_OPRM"" T0 "
            ...
            If Not oRecordSet.EoF Then
                ...
                Try
                    ...
                    Else
                        ...
                        oMatrix.Columns.Item("11").Cells().Item(oMatrix.RowCount - 1).Specific.value = oRecordSet.Fields.Item("U_Z_OQty").Value
                        Try
