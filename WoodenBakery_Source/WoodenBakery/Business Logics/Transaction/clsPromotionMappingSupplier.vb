Public Class clsPromotionMappingSupplier
    Inherits clsBase
    ...
    Public Sub LoadForm()
        Try
            oForm = oApplication.Utilities.LoadForm(xml_Z_OCPRS, frm_Z_OCPRS)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_Z_OCPRS Then
...
#Region "Function"
    ...
    Private Sub LoadPromotion(ByVal aform As SAPbouiCOM.Form)
        Try
            ...
            strqry = " Select 'Y' As ""Select"",""CardCode"",""CardName"" From OCRD Where ""CardType"" = 'S' "
    ...
    Private Sub FillCombo(ByVal aForm As SAPbouiCOM.Form)
        Try
            ...
            oTempRec.DoQuery("Select ""GroupCode"",""GroupName"" From OCRG Where ""GroupType"" = 'S'")
